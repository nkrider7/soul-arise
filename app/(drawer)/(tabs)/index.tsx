...
import AnimatedCornerIconModal from '~/components/Home/AnimatedModal';
		...
		<>
			<View style={{ backgroundColor: lightTheme.background }} className='flex-1  items-center'>
				...
				<View className="flex-row items-center  w-full justify-between px-4 pt-10 pb-3  rounded-t-2xl ">
					...
					<Image source={require('../../../assets/icons/icons.png')} className="w-12 h-12 rounded-2xl" resizeMode="contain" />
				...
				<ScrollView className='w-full '>
					...
					<AnimatedCornerIconModal visible={visible} onClose={() => setVisible(false)} backgroundColor={lightTheme.background}> 
						...
						<TouchableWithoutFeedback onPress={() => setVisible(false)}>
							<View className="flex-1 bg-black/80 items-center justify-center">
								<TouchableWithoutFeedback>
									<View
										className="w-64 h-80 relative items-center border-[1px] border-purple-200 justify-center"
									...
									>
										...
										<AppText className='text-3xl text-white' > Helloo</AppText>
									</View>
								</TouchableWithoutFeedback>
							</View>
						</TouchableWithoutFeedback>
